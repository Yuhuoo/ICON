...
if __name__ == "__main__":
    ...
    for data in pbar:
        ...
        if cfg.net.prior_type == "refinepifu":
            in_tensor.update(
                dataset.compute_voxel_verts(
                    optimed_pose,
                    optimed_orient,
        ...
        # ipdb.set_trace()
        # icon-filter:['smpl_faces', 'image', 'smpl_joint', 'T_normal_F', 'T_normal_B', 'normal_F', 'normal_B', 'smpl_verts', 'smpl_vis', 'smpl_cmap', 'smpl_norm']
        # pamir: ['smpl_faces', 'image', 'smpl_joint', 'T_normal_F', 'T_normal_B', 'normal_F', 'normal_B', 'smpl_verts', 'smpl_vis', 'smpl_cmap', 'smpl_norm', 'voxel_verts', 'voxel_faces', 'pad_v_num', 'pad_f_num']
        with torch.no_grad():
